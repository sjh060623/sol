        ...
        {/*sec container*/}
         ...
         <div className="w-80 h-36 rounded-2xl mt-7 shadow-sm translate-y-10 border-2 bg-white">
          <div className="flex flex-row">
            ...
            <div>
              <div className="flex flex-row">
                <h1 className=" translate-y-4">삼성진지원금</h1>
                <h1 className=" translate-y-4 text-gray-500">
                  [쏠편한비상금]
                </h1>
              </div>
        ...
        {/*sec container*/}
         ...
         <div className="w-80 h-36 rounded-2xl mt-7 shadow-sm translate-y-10 border-2 bg-white">
          <div className="flex flex-row">
            ...
            <div>
              <div className="flex flex-row">
                <h1 className=" translate-y-4">현수게이지원금</h1>
                <h1 className=" translate-y-4 text-gray-500">
                  [쏠편한비상금]
                </h1>
              </div>
            ...
            <Image
              className="w-5 h-5 -translate-x-12 translate-y-9"
              src={require("public/copy.png")}
            />
          </div>

          <div className="flex flex-row">
            <h1 className="font-bold text-lg translate-x-64  translate-y-4">
          0원
            </h1>
          </div>
          <Link href="managy">
